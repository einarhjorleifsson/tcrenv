...
The function for standard error is not availble in R. A remedy is that you use college statistical knowledge to derive them from the appropriate variables you derived above. The Wikipedia page for [Standard error](https://en.wikipedia.org/wiki/Standard_error) is one place to check.
