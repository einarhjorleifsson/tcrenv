...
2. Type in a directory name (e.g. "first-ggplot")
...
4. Save your script, e.g. as "minke-data.R" within your current project.
:::
...
## Suggested 1st reading

* [r4ds: Chapter 1  Data visualization](https://r4ds.hadley.nz/data-visualize)
* [r4ds: Chapter 9  Layers](https://r4ds.hadley.nz/layers)
